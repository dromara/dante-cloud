 ...
 * File Name: OAuth2StaticExpressions.java
 * Author: gengwei.zheng
 * Date: 2021/08/05 17:04:05
 */
...
/**
 * <p>Description: OAuth2 表达式 </p>
 *
 * @author : gengwei.zheng
 * @date : 2021/8/5 17:04
 */
@ApiModel(description = "OAuth2 表达式")
@Entity
@Table(name = "oauth_static_expressions", indexes = {@Index(name = "oauth_static_expressions_id_idx", columnList = "expression_id")})
@Cacheable
...
public class OAuth2StaticExpressions extends BaseSysEntity {
