...
import cn.herodotus.eurynome.bpmn.logic.entity.ActIdTenantMember;
import cn.herodotus.eurynome.bpmn.logic.service.ActIdTenantMemberService;
...
public class ActIdTenantMemberProcessor extends AbstractProcessor<ActIdTenantMember> {
    ...
    public ActIdTenantMember saveOrUpdate(ActIdTenantMember entity) {
        return this.actIdTenantMemberService.saveOrUpdate(entity);
    }
}
