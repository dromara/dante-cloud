...
INSERT ALL
  INTO ACT_RU_AUTHORIZATION (ID_, TYPE_, GROUP_ID_, RESOURCE_TYPE_, RESOURCE_ID_, PERMS_, REV_) VALUES ('operaton-admin-grant-tenant', 1, 'operaton-admin', 11, '*', 2147483647, 1)
  INTO ACT_RU_AUTHORIZATION (ID_, TYPE_, GROUP_ID_, RESOURCE_TYPE_, RESOURCE_ID_, PERMS_, REV_) VALUES ('operaton-admin-grant-tenant-membership', 1, 'operaton-admin', 12, '*', 2147483647, 1)
  INTO ACT_RU_AUTHORIZATION (ID_, TYPE_, GROUP_ID_, RESOURCE_TYPE_, RESOURCE_ID_, PERMS_, REV_) VALUES ('operaton-admin-grant-batch', 1, 'operaton-admin', 13, '*', 2147483647, 1)
SELECT * FROM dual;
