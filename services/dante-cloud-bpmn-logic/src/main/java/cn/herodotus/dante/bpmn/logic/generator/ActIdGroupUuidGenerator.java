 ...
 */
public class ActIdGroupUuidGenerator extends AbstractUuidGenerator {

    public ActIdGroupUuidGenerator(ActIdGroupUuid config, Member idMember, CustomIdGeneratorCreationContext creationContext) {
        super(idMember);
    }
