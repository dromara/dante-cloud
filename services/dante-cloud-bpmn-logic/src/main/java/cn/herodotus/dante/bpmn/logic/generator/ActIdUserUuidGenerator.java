 ...
 */
public class ActIdUserUuidGenerator extends AbstractUuidGenerator {

    public ActIdUserUuidGenerator(ActIdUserUuid config, Member idMember, CustomIdGeneratorCreationContext creationContext) {
        super(idMember);
    }
