...
@Entity
@Table(name = "oauth_scope", indexes = {@Index(name = "oauth_scope_sid_idx", columnList = "scope_id")})
@NamedEntityGraphs({
        @NamedEntityGraph(
                name = "OauthScopeWithAndAuthority",
                attributeNodes = {
                        @NamedAttributeNode(value = "authorities")
                })
})
public class OauthScope extends BaseSysEntity {
