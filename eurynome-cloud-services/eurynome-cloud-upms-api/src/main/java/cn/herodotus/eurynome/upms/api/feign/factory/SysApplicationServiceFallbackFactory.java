...
@Component
public class SysApplicationServiceFallbackFactory implements FallbackFactory<ISysApplicationService> {

    @Override
    public ISysApplicationService create(Throwable throwable) {
