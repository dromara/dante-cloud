...
/**
 * <p>Description: OauthClientDetail </p>
 *
...
public class OauthClientDetail extends AbstractDomain {

    @Id
    @GeneratedValue(generator = "oauthclientdetail-uuid")
    @GenericGenerator(name = "oauthclientdetail-uuid", strategy = "cn.herodotus.eurynome.upms.api.generator.OauthClientDetailUUIDGenerator")
