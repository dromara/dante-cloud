...
import cn.herodotus.eurynome.component.rest.feign.HerodotusFallbackFactory;
...
public class HerodotusSentinelFeign {
    ...
    public static HerodotusSentinelFeign.Builder builder() {
    ...
    public static final class Builder extends Feign.Builder
        ...
        @Override
        public HerodotusSentinelFeign.Builder contract(Contract contract) {
        ...
        public Feign build() {
            super.invocationHandlerFactory(new InvocationHandlerFactory() {
                ...
                public InvocationHandler create(Target target,
                    ...
                    Object feignClientFactoryBean = HerodotusSentinelFeign.Builder.this.applicationContext
