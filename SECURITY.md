...
dante-cloud is a Spring Cloud / Spring Authorization Server-based microservice + OAuth2 framework supporting password, client_credentials, authorization_code, and social login flows. The maintainers support security fixes on the latest minor release. Older releases will not generally receive backports.

In-scope vulnerability classes include:

- Authentication / authorization bypass
- OAuth2 / OIDC protocol implementation flaws (PKCE, redirect-URI handling, scope escalation)
- JWT / token signature / claims handling flaws
- Session fixation, social-login linking flaws
