...
1.10.2-2022.0.1、Spring Cloud Alibaba 2021.0.5.0、Nacos 2.2.2 等主流技术栈开发的 Dante Cloud v3.0.0
...
Alibaba 2021.0.5.0、Spring Authorization Server 0.4.1、Nacos 2.2.2 等最新版本开发，遵循 SpringBoot
