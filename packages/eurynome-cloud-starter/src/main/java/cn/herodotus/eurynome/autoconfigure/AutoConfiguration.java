...
import cn.herodotus.eurynome.rest.definition.RequestMappingScan;
...
public class AutoConfiguration {
    ...
    @ConditionalOnBean({SecurityMetadataMessageProducer.class, SecurityMetadataService.class})
    public SecurityMetadataPersistence securityMetadataPersistence(SecurityMetadataMessageProducer securityMetadataMessageProducer, SecurityMetadataService securityMetadataService) {
        SecurityMetadataPersistence securityMetadataPersistence = new SecurityMetadataPersistence(securityMetadataService, securityMetadataMessageProducer);
