package cn.herodotus.eurynome.integration.compliance.configuration;

import cn.herodotus.eurynome.integration.compliance.properties.AliyunScanProperties;
 ...
 */
@Slf4j
@EnableConfigurationProperties(AliyunScanProperties.class)
@ComponentScan(basePackages = {
        "cn.herodotus.eurynome.integration.compliance.service.aliyun"
})
public class AliyunScanConfiguration {

    @PostConstruct
    public void init() {
        log.info("[Eurynome] |- Bean [Aliyun Shield] Auto Configure.");
    }

    @Autowired
    private AliyunScanProperties aliyunScanProperties;

    @Bean
    @ConditionalOnMissingBean
    public IAcsClient iAcsClient() {
        IClientProfile iClientProfile = DefaultProfile.getProfile(aliyunScanProperties.getRegionId(), aliyunScanProperties.getAccessKeyId(), aliyunScanProperties.getAccessKeySecret());
    ...
    public TextScanRequest textScanRequest() {
        ...
        textScanRequest.setSysRegionId(aliyunScanProperties.getRegionId());
        // 请务必设置超时时间
        textScanRequest.setSysConnectTimeout(aliyunScanProperties.getText().getConnectTimeout());
        textScanRequest.setSysReadTimeout(aliyunScanProperties.getText().getReadTimeout());
    ...
    public TextFeedbackRequest textFeedbackRequest() {
        ...
        //指定请求方法
        textFeedbackRequest.setSysMethod(com.aliyuncs.http.MethodType.POST);
        textFeedbackRequest.setSysEncoding(StandardCharsets.UTF_8.name());
        textFeedbackRequest.setSysRegionId(aliyunScanProperties.getRegionId());
        // 请务必设置超时时间
        textFeedbackRequest.setSysConnectTimeout(aliyunScanProperties.getText().getConnectTimeout());
        textFeedbackRequest.setSysReadTimeout(aliyunScanProperties.getText().getReadTimeout());
    ...
    public ImageSyncScanRequest imageSyncScanRequest() {
         ...
         */
        imageSyncScanRequest.setSysConnectTimeout(aliyunScanProperties.getImage().getConnectTimeout());
        imageSyncScanRequest.setSysReadTimeout(aliyunScanProperties.getImage().getReadTimeout());
    ...
    public ImageAsyncScanRequest imageAsyncScanRequest() {
         ...
         * 如果您设置的ReadTimeout小于服务端处理的时间，程序中会获得一个read timeout异常
         */
        imageAsyncScanRequest.setSysConnectTimeout(aliyunScanProperties.getImage().getConnectTimeout());
        imageAsyncScanRequest.setSysReadTimeout(aliyunScanProperties.getImage().getReadTimeout());
    ...
    public ImageAsyncScanResultsRequest imageAsyncSacnResultsRequest() {
         ...
         * 如果您设置的ReadTimeout小于服务端处理的时间，程序中会获得一个read timeout异常
         */
        imageAsyncScanResultsRequest.setSysConnectTimeout(aliyunScanProperties.getImage().getConnectTimeout());
        imageAsyncScanResultsRequest.setSysReadTimeout(aliyunScanProperties.getImage().getReadTimeout());
    ...
    public VideoSyncScanRequest videoSyncScanRequest() {
         ...
         * 请务必设置超时时间
         */
        videoSyncScanRequest.setSysConnectTimeout(aliyunScanProperties.getVideo().getConnectTimeout());
        videoSyncScanRequest.setSysReadTimeout(aliyunScanProperties.getVideo().getReadTimeout());
    ...
    public VideoAsyncScanRequest videoAsyncScanRequest() {
         ...
         * 请务必设置超时时间
         */
        videoAsyncScanRequest.setSysConnectTimeout(aliyunScanProperties.getVideo().getConnectTimeout());
        videoAsyncScanRequest.setSysReadTimeout(aliyunScanProperties.getVideo().getReadTimeout());
    ...
    public VideoAsyncScanResultsRequest videoAsyncResultRequest() {
         ...
         * 请务必设置超时时间
         */
        videoAsyncResultRequest.setSysConnectTimeout(aliyunScanProperties.getVideo().getConnectTimeout());
        videoAsyncResultRequest.setSysReadTimeout(aliyunScanProperties.getVideo().getReadTimeout());
    ...
    public VoiceAsyncScanRequest voiceAsyncScanRequest() {
        ...
        voiceAsyncScanRequest.setSysRegionId(aliyunScanProperties.getRegionId());
        voiceAsyncScanRequest.setSysConnectTimeout(aliyunScanProperties.getVoice().getConnectTimeout());
        voiceAsyncScanRequest.setSysReadTimeout(aliyunScanProperties.getVoice().getReadTimeout());
    ...
    public VoiceAsyncScanResultsRequest voiceAsyncResultsRequest() {
        ...
        voiceAsyncScanResultsRequest.setSysRegionId(aliyunScanProperties.getRegionId());
        /**
         * 请务必设置超时时间
         */
        voiceAsyncScanResultsRequest.setSysConnectTimeout(aliyunScanProperties.getVoice().getConnectTimeout());
        voiceAsyncScanResultsRequest.setSysReadTimeout(aliyunScanProperties.getVoice().getReadTimeout());
