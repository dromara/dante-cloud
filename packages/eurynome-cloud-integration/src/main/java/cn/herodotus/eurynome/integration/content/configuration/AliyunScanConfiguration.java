...
public class AliyunScanConfiguration {
    ...
    public IAcsClient iAcsClient() {
        IClientProfile iClientProfile = DefaultProfile.getProfile(aliyunScanProperties.getRegionId(), aliyunProperties.getAccessKeyId(), aliyunProperties.getAccessKeySecret());
    ...
    public VoiceSyncScanRequest voiceSyncScanRequest() {
        ...
        voiceSyncScanRequest.setSysRegionId(aliyunScanProperties.getRegionId());
        voiceSyncScanRequest.setSysConnectTimeout(aliyunScanProperties.getVoice().getConnectTimeout());
        voiceSyncScanRequest.setSysReadTimeout(aliyunScanProperties.getVoice().getReadTimeout());
