 ...
 * Date: 2021/4/10 下午4:06
 * LastModified: 2021/4/10 下午4:06
 */
...
public class WxappOpenController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "wxappRequest", required = true, value = "微信小程序自定义参数实体", dataType = "WxappRequest", dataTypeClass = WxappRequest.class, paramType = "query"),
    })
    @PostMapping("/login")
