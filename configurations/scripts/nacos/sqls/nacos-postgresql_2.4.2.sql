...
SELECT setval('"public"."config_info_id_seq"', 108, true);
...
SELECT setval('"public"."his_config_info_nid_seq"', 146, true);
...
SELECT setval('"public"."tenant_info_id_seq"', 3, true);
