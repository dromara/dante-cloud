...
import cn.herodotus.engine.security.extend.enhance.HerodotusJwtTokenEnhancer;
import cn.herodotus.engine.security.extend.response.HerodotusWebResponseExceptionTranslator;
...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private HerodotusClientDetailsService clientDetailsService;
    @Autowired
    private HerodotusUserDetailsService userDetailsService;
    @Autowired
    ...
    public void postConstruct() {
        log.debug("[Herodotus] |- Core [Herodotus Authorization Server in component oauth] Auto Configure.");
    }
