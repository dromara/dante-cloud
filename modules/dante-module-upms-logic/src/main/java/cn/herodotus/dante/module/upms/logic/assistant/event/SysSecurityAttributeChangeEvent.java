 ...
 * @date : 2021/8/4 22:18
 */
public class SysSecurityAttributeChangeEvent extends LocalApplicationEvent<SysSecurityAttribute> {

    public SysSecurityAttributeChangeEvent(SysSecurityAttribute data) {
        super(data);
    }

    public SysSecurityAttributeChangeEvent(SysSecurityAttribute data, Clock clock) {
        super(data, clock);
    }
}
