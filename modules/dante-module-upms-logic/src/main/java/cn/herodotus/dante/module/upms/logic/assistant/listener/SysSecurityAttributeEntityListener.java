 ...
 * @date : 2021/8/4 16:54
 */
public class SysSecurityAttributeEntityListener extends AbstractEntityListener {
    ...
    protected void postUpdate(SysSecurityAttribute entity) {
        log.debug("[Herodotus] |- (1) SysSecurityAttribute entity @PostUpdate actived, value is : [{}]. Trigger SysSecurityAttribute change event.", entity.toString());
        publishEvent(new SysSecurityAttributeChangeEvent(entity));
    }
}
