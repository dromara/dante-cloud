...
package cn.herodotus.eurynome.module.upms.entity.system;
...
public class SysAuthority extends BaseSysEntity {
    ...
    @GenericGenerator(name = "authority-uuid", strategy = "cn.herodotus.eurynome.module.upms.assistant.generator.SysAuthorityUUIDGenerator")
