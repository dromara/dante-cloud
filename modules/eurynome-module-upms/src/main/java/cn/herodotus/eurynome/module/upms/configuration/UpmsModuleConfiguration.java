...
package cn.herodotus.eurynome.module.upms.configuration;
...
@EntityScan(basePackages = {
        "cn.herodotus.eurynome.module.upms.entity.system",
        "cn.herodotus.eurynome.module.upms.entity.hr",
})
@EnableJpaRepositories(basePackages = {
        "cn.herodotus.eurynome.module.upms.repository.system",
        "cn.herodotus.eurynome.module.upms.repository.hr",
})
@ComponentScan(basePackages = {
        "cn.herodotus.eurynome.module.upms.service.system",
        "cn.herodotus.eurynome.module.upms.service.hr",
})
public class UpmsModuleConfiguration {

    private static final Logger log = LoggerFactory.getLogger(UpmsModuleConfiguration.class);
