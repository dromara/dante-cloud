...
/**
 * <p>Description: SysSecurityAttribute实体数据变更监听器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2022/3/30 12:18
 */
@Service
public class SecurityAttributeChangedProcessor {

    private final SecurityMetadataDistributeProcessor securityMetadataDistributeProcessor;

    @Autowired
    public SecurityAttributeChangedProcessor(SecurityMetadataDistributeProcessor securityMetadataDistributeProcessor) {
    ...
    public void distributeChangedSecurityAttribute(SysSecurityAttribute sysSecurityAttribute) {
        securityMetadataDistributeProcessor.distributeChangedSecurityAttribute(sysSecurityAttribute);
    }
}
