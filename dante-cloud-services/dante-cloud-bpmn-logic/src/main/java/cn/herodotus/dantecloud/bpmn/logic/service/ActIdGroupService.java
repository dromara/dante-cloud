...
import cn.herodotus.dantecloud.bpmn.logic.entity.ActIdGroup;
import cn.herodotus.dantecloud.bpmn.logic.repository.ActIdGroupRepository;
 ...
 */
@Service
public class ActIdGroupService implements BaseJpaWriteableService<ActIdGroup, String> {
    ...
    @Override
    public BaseJpaRepository<ActIdGroup, String> getRepository() {
