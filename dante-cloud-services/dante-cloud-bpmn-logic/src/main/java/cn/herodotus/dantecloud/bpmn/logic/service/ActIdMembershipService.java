...
package cn.herodotus.dantecloud.bpmn.logic.service;

import org.dromara.dante.data.jpa.repository.BaseJpaRepository;
import org.dromara.dante.data.jpa.service.BaseJpaWriteableService;
import cn.herodotus.dantecloud.bpmn.logic.entity.ActIdMembership;
import cn.herodotus.dantecloud.bpmn.logic.repository.ActIdMembershipRepository;
 ...
 */
@Service
public class ActIdMembershipService implements BaseJpaWriteableService<ActIdMembership, String> {
    ...
    @Override
    public BaseJpaRepository<ActIdMembership, String> getRepository() {
