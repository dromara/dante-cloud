...
import cn.herodotus.dantecloud.bpmn.logic.entity.ActIdUser;
import cn.herodotus.dantecloud.bpmn.logic.repository.ActIdUserRepository;
 ...
 */
@Service
public class ActIdUserService implements BaseJpaWriteableService<ActIdUser, String> {
    ...
    @Override
    public BaseJpaRepository<ActIdUser, String> getRepository() {
