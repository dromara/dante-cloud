...
-- ----------------------------
INSERT INTO "oauth2_application" ("application_id", "create_time", "ranking", "update_time", "description", "is_reserved", "reversion", "status", "abbreviation", "access_token_validity", "application_name", "application_type", "authorization_grant_types", "client_authentication_methods", "client_id", "client_secret", "client_secret_expires_at", "homepage", "jwk_set_url", "logo", "redirect_uris", "refresh_token_validity", "require_authorization_consent", "require_proof_key", "reuse_refresh_tokens", "signature_algorithm", "access_token_format", "signing_algorithm") VALUES ('dfe3e7bc-22e9-443f-a874-947494e20174', '2022-03-18 18:51:00.191', 1, '2022-03-26 18:52:42.301', NULL, 'f', 0, 0, 'Eurynome Cloud UI', 7200000000000, '业务中台管理系统', 0, 'refresh_token,password,authorization_code,social_credentials', 'client_secret_basic', '14a9cf797931430896ad13a6b1855611', 'a05fe1fc50ed42a4990c6c6fc4bec398', '2023-12-31 00:00:00', NULL, NULL, NULL, 'http://192.168.101.10:8847/eurynome-cloud-upms/open/authorized', 86400000000000, 't', 'f', 't', 0, 0, 0);

-- ----------------------------
-- Table data for oauth2_registered_client
-- ----------------------------
INSERT INTO "oauth2_registered_client" ("id", "authorization_grant_types", "client_authentication_methods", "client_id", "client_id_issued_at", "client_name", "client_secret", "client_secret_expires_at", "client_settings", "redirect_uris", "scopes", "token_settings") VALUES ('dfe3e7bc-22e9-443f-a874-947494e20174', 'refresh_token,password,authorization_code,social_credentials', 'client_secret_basic', '14a9cf797931430896ad13a6b1855611', '2022-03-18 18:51:00.373', 'dfe3e7bc-22e9-443f-a874-947494e20174', '{bcrypt}$2a$10$dJv1leI6jf8PUiIhBE1fu.lPQ6hSsurWSdMHBFXPnzizuw9wsnte2', '2023-12-31 00:00:00', '{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-authorization-consent":true,"settings.client.token-endpoint-authentication-signing-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.client.require-proof-key":false}', 'http://192.168.101.10:8847/eurynome-cloud-upms/open/authorized', 'all,openid', '{"@class":"java.util.Collections$UnmodifiableMap","settings.token.reuse-refresh-tokens":true,"settings.token.id-token-signature-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.token.access-token-time-to-live":["java.time.Duration",7200.000000000],"settings.token.access-token-format":{"@class":"org.springframework.security.oauth2.core.OAuth2TokenFormat","value":"self-contained"},"settings.token.refresh-token-time-to-live":["java.time.Duration",86400.000000000]}');
...
INSERT INTO "oauth2_application_scope" ("application_id", "scope_id") VALUES ('dfe3e7bc-22e9-443f-a874-947494e20174', '62197e92-2b22-4584-a32d-852f684c6d2c');
