...
-- ----------------------------
INSERT INTO "oauth2_application" ("application_id", "create_time", "ranking", "update_time", "description", "is_reserved", "reversion", "status", "abbreviation", "access_token_format", "access_token_validity", "application_name", "application_type", "signing_algorithm", "authorization_grant_types", "client_authentication_methods", "client_id", "client_secret", "client_secret_expires_at", "homepage", "signature_algorithm", "jwk_set_url", "logo", "redirect_uris", "refresh_token_validity", "require_authorization_consent", "require_proof_key", "reuse_refresh_tokens") VALUES ('422baa83-505c-436f-87b5-2a599e6d2d28', '2022-04-02 16:26:26.26', 0, '2022-04-02 16:26:26.26', NULL, 't', 0, 0, 'Eurynome Cloud UI（PKCE）', 0, 7200000000000, '业务中台管理系统（PKCE）', 0, NULL, 'refresh_token,password,client_credentials,authorization_code,social_credentials', 'client_secret_post,client_secret_basic', '67601992f3574c75809a3d79888bf16e', '3e62c1f9678a4dba81b31ad9f6ab8940', NULL, NULL, 0, NULL, NULL, 'http://192.168.101.10:8847/eurynome-cloud-upms/open/authorized', 864000000000000, 't', 't', 't');
INSERT INTO "oauth2_application" ("application_id", "create_time", "ranking", "update_time", "description", "is_reserved", "reversion", "status", "abbreviation", "access_token_format", "access_token_validity", "application_name", "application_type", "signing_algorithm", "authorization_grant_types", "client_authentication_methods", "client_id", "client_secret", "client_secret_expires_at", "homepage", "signature_algorithm", "jwk_set_url", "logo", "redirect_uris", "refresh_token_validity", "require_authorization_consent", "require_proof_key", "reuse_refresh_tokens") VALUES ('dfe3e7bc-22e9-443f-a874-947494e20174', '2022-03-18 18:51:00.191', 1, '2022-04-02 16:27:04.052', NULL, 't', 0, 0, 'Eurynome Cloud UI', 0, 7200000000000, '业务中台管理系统', 0, 0, 'refresh_token,password,client_credentials,authorization_code,social_credentials', 'client_secret_post,client_secret_basic', '14a9cf797931430896ad13a6b1855611', 'a05fe1fc50ed42a4990c6c6fc4bec398', '2023-12-31 00:00:00', NULL, 0, NULL, NULL, 'http://192.168.101.10:8847/eurynome-cloud-upms/open/authorized', 86400000000000, 't', 'f', 't');
...
INSERT INTO "oauth2_registered_client" ("id", "authorization_grant_types", "client_authentication_methods", "client_id", "client_id_issued_at", "client_name", "client_secret", "client_secret_expires_at", "client_settings", "redirect_uris", "scopes", "token_settings") VALUES ('dfe3e7bc-22e9-443f-a874-947494e20174', 'refresh_token,password,client_credentials,authorization_code,social_credentials', 'client_secret_post,client_secret_basic', '14a9cf797931430896ad13a6b1855611', '2022-03-18 18:51:00.373', 'dfe3e7bc-22e9-443f-a874-947494e20174', '{bcrypt}$2a$10$yMB9ze2Ny2xMa/xHSFX4H.DQkYH5gbZNRXFaPdv.MIhBbWPntZ382', '2023-12-31 00:00:00', '{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-authorization-consent":true,"settings.client.token-endpoint-authentication-signing-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.client.require-proof-key":false}', 'http://192.168.101.10:8847/eurynome-cloud-upms/open/authorized', 'read-user-by-page,openid', '{"@class":"java.util.Collections$UnmodifiableMap","settings.token.reuse-refresh-tokens":true,"settings.token.id-token-signature-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.token.access-token-time-to-live":["java.time.Duration",7200.000000000],"settings.token.access-token-format":{"@class":"org.springframework.security.oauth2.core.OAuth2TokenFormat","value":"self-contained"},"settings.token.refresh-token-time-to-live":["java.time.Duration",86400.000000000]}');
